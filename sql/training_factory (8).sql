...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 10 jan 2020 om 12:52
...
INSERT INTO `lesson` (`id`, `time`, `date`, `location`, `max_persons`, `les_naam`, `training_id`, `instructeur_id`) VALUES
(1, '20:17:00', '2014-01-01', 'de hal', 22, 'Stootzak training test', 1, 9),
(3, '03:05:00', '2014-01-01', 'de hal', 13, 'Stootzak training', 3, 9),
(6, '18:14:00', '2015-01-01', 'ffff', 2, 'Kickboxen', 3, 9);
...
('20191218114737', '2019-12-18 11:47:53'),
('20191218125937', '2019-12-18 12:59:41'),
('20191218131223', '2019-12-18 13:12:46'),
('20200108110245', '2020-01-08 11:03:02');
...
(1, 'dylan', '$argon2id$v=19$m=65536,t=4,p=1$c1RqVGJmYi5nR3RqV1ZDQQ$NKBmLPnM0BuYqIxs746ZN5n/EXOIZLWHIgHmq4puuCA', 'dylan@mail.com', 'Dhr.', 'van der Hout', '2000-01-01', 'man', '[\"ROLE_USER\"]', '2015-01-01', '2000.00', 'Molenstraat', '1234AB', 'Den Haag', 'Dylan'),
...
(9, 'o', '$argon2id$v=19$m=65536,t=4,p=1$cUVZaDM5YndFTm41cGkzdQ$Go8oQuzdmOS7LAVERG3pW2hCKHJxhqYd/PKn76OYoxA', 'o@o.o', 'Dhr.', 'o', '1899-10-01', 'man', '[\"ROLE_INSTRUCTEUR\"]', NULL, NULL, 'o', 'o', 'o', 'Thijs'),
(10, 'kat', '$argon2id$v=19$m=65536,t=4,p=1$ejN0WENXWHMzYWE1TEVKcg$PVK/ny6H3eJtzWK5gCts4MsYIS/WAFwti9fN+awx0l0', 'kat@kat.kat', 'Dhr.', 'kat', '1900-01-01', 'man', '[]', NULL, NULL, 'kat', 'kat', 'kat', 'kat');
...
--
ALTER TABLE `lesson`
  ADD CONSTRAINT `FK_F87474F325FCA809` FOREIGN KEY (`instructeur_id`) REFERENCES `persoon` (`id`),
