 ...
 */
final class Version20191210112052 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE persoon CHANGE roles roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', CHANGE hiring_date hiring_date DATE DEFAULT NULL, CHANGE salary salary NUMERIC(10, 2) DEFAULT NULL, CHANGE ingeschreven_lessen ingeschreven_lessen LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
