 ...
 */
final class Version20191211125943 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE persoon ADD ingeschreven_lessen LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE hiring_date hiring_date DATE DEFAULT NULL, CHANGE salary salary NUMERIC(10, 2) DEFAULT NULL');
